...
strategy:
  matrix:
    openfoam-version: [12, 13, 2512, 2606]  # Add other versions here if needed
  fail-fast: false
steps:
- uses: actions/checkout@v7
...
- **`ubuntu-24.04`**: 2606, 2512, 2506, 2412, 2406, 2312, 2306, 2212 (openfoam.com), 13, 12, 11 (openfoam.org)

- **`ubuntu-22.04`**: 2606, 2512, 2506, 2412, 2406, 2312, 2306, 2212, 2206, 2112, 2106, 2012, 2006 (openfoam.com), 13, 12, 11, 10, 9 (openfoam.org)

- **`ubuntu-24.04-arm`**: 2606, 2512, 2506, 2412 (openfoam.com), 13, 12, 11 (openfoam.org)

- **`ubuntu-22.04-arm`**: 2606, 2512, 2506, 2412, 2406 (openfoam.com), 13, 12, 11 (openfoam.org)
...
- [Docker `container`](https://docs.github.com/en/actions/writing-workflows/choosing-where-your-workflow-runs/running-jobs-in-a-container) based on:
  ...
  - `ubuntu:26.04`: 2606, 2512, 2506, 2412, 2406, 2312, 2306, 2212 (openfoam.com), 13 (openfoam.org)
